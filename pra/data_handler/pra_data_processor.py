	...
	def create_relations_file(self):
		...
		with open('relations', 'w') as csvfile:
			...
			for r in self.relation_set:
				if self.use_domain:
					writer.writerow(['concept:' + r,
									 '{{}}',
									 'true',
									 '{"object"}',
									 self.domain_range_dic[r][0],
									 self.domain_range_dic[r][1],
									 'true',
									 'concept:' + self.domain_range_dic[r][0],
									 'concept:' + self.domain_range_dic[r][1],
									 '',
									 '(empty set)',
									 '(empty set)',
									 'any',
		...
		with open(filename, 'w') as csvfile:
			...
			if self.use_domain:
				...
				for k in self.entity_set:
					writer.writerow(['concept:' + k,
									 'generalizations',
									 'concept:' + self.type_dic[k],
									 '',
									 '1.0',
									 '',
									 ''])
