...
Description:
	Python script to integrate the data.

To-do:
	1. Change to class
	2. Remove first line from first line of the map_file
"""
...
def integrate_data(data_paths, map_file, data_rule_file):
	list_integrated_data = []

	for idx, row in data_paths.iterrows():
