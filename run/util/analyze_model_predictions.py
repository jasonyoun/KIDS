...
with open(_file, 'w') as t_f, open(stats_file, 'w') as f:
    t_f.write('Antibiotic'+'\t'+'genes_resist'+'\t'+'test_edges'+'\t'+'dev_edges'+'\t'+'edges_in_train'+'\t'+'confer_edges_in_train'+'\n')
    f.write('Antibiotic'+'\t'+'genes_resist'+'\t'+'test_edges'+'\t'+'dev_edges'+'\t'+'edges_in_train'+'\t'+'confer_edges_in_train'+'\t'+'er_tp'+'\t'+'er_tn'+'\t'+'er_fp'+'\t'+'pra_tp'+'\t'+'pra_tn'+'\t'+'pra_fp'+'\t'+'stacked_tp'+'\t'+'stacked_tn'+'\t'+'stacked_fp'+'\t'+'er_precision'+'\t'+'pra_precision'+'\t'+'stacked_precision'+'\t'+'er_recall'+'\t'+'pra_recall'+'\t'+'stacked_recall'+'\t'+'er_f1'+'\t'+'pra_f1'+'\t'+'stacked_f1'+'\n')
    for fold in args.dir:
        ...
        for k,v in data_antibiotic_confers_dic.items():
            ...
            t_f.write(k+'\t'+str(v)+'\t'+str(test_count)+'\t'+str(dev_count)+'\t'+str(train_count)+'\t'+str(train_confers_count)+'\n')
