...
def run_model(
	...
	if WORD_EMBEDDING:
		indexed_entities, num_entity_words, entity_dic = processor.machine_translate_using_word(DATA_PATH + '/entities.txt')
		indexed_predicates, num_pred_words, pred_dic = processor.machine_translate_using_word(DATA_PATH + '/relations.txt')
	else:
		entity_dic = processor.machine_translate(DATA_PATH + '/entities.txt', separator='#SPACE#|#COMMA#|#SEMICOLON#|\W+')
		pred_dic = processor.machine_translate(DATA_PATH + '/relations.txt', separator='#SPACE#|#COMMA#|#SEMICOLON#|\W+')
