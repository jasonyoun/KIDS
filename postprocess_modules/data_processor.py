...
class DataProcessor():
    ...
    def generate_hypotheses(self, pd_with_label, entity_dic, relations):
        ...
        for relation in relations:
            ...
            known_sub_obj_tuple_list = [tuple(x) for x in pd_known[[self._SUB_STR, self._OBJ_STR]].values]
            ...
            pd_hypotheses_to_append = pd.DataFrame(unknown_combinations, columns=[self._SUB_STR, self._OBJ_STR])
